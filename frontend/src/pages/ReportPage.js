...
import { MapPin, Send, CheckCircle, AlertTriangle, Waves, TreePine, Car } from 'lucide-react';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const reportData = {
        ...
        reporter_id: null // Will be set when authentication is implemented
      };
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Help your community by reporting environmental issues, infrastructure problems, 
            and safety concerns. Your reports help local authorities take timely action.
          </p>
        </div>
        ...
        {showSuccess && (
          <Alert className="mb-6 bg-green-50 border-green-200">
            ...
            <AlertDescription className="text-green-700">
              <strong>Report submitted successfully!</strong> Local authorities have been notified and will review your report.
            </AlertDescription>
          </Alert>
        )}
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <Card className="report-card">
              <CardHeader>
                <CardTitle className="text-2xl text-gray-800">Submit New Report</CardTitle>
                <p className="text-gray-600">Select a location and describe the issue</p>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    type="submit"
                    disabled={loading || !formData.location || !formData.report_type || !formData.description.trim()}
                ...
                {recentReports.length > 0 ? (
                  <div className="space-y-3" data-testid="recent-reports-list">
                    {recentReports.map((report, index) => {
                      ...
                      const severityColor = severityOptions.find(s => s.value === report.severity)?.color || 'bg-gray-100';
                  ...
                  <p className="text-gray-500 text-center py-8">
                    No recent reports. Be the first to report an issue in your area!
                  </p>
                )}
              </CardContent>
            </Card>
